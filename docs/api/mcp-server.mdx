...
Then restart Claude Code. You'll have access to 42 tools for managing agents, teams, workspaces, and more.`}
...
The MCP server exposes **42 tools** organized into these categories:
