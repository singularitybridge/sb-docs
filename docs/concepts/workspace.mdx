...
<a href="/features/vector-search" className="nextstep-card">
  <Search size={20} className="nextstep-icon" />
  <h3>Vector Search</h3>
  <p>Semantic document retrieval</p>
</a>
<a href="/features/rag" className="nextstep-card">
  <Database size={20} className="nextstep-icon" />
  <h3>RAG</h3>
  <p>Retrieval-augmented generation</p>
</a>
<a href="/api/endpoints/workspace" className="nextstep-card">
  <Code size={20} className="nextstep-icon" />
  <h3>Workspace API</h3>
  <p>Workspace endpoint reference</p>
</a>
</div>
